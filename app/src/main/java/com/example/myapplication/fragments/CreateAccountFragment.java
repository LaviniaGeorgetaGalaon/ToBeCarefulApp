        ...
        signUpBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(name.isEmpty() || name.equals(" ")){
                    nameET.setError("Va rugam introduceți un nume valid");
                    return;
                }
                ...
                if(parola.isEmpty() || parola.length()<6){
                    parolaET.setError("Va rugam introduceți o parolă validă");
                    return;
                }
                if(!parola.equals(confirmaParola)){
                    confirmaParolaET.setError("Parola introdusă nu este aceeasi!");
                    return;
                }
