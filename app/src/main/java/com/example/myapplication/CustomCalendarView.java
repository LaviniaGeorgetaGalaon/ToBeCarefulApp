...
public class CustomCalendarView extends LinearLayout {
    ...
    SimpleDateFormat dateFormat = new SimpleDateFormat("MMMM yyyy", aLocale);
    SimpleDateFormat monthFormat = new SimpleDateFormat("MMMM", aLocale);
    SimpleDateFormat yearFormat = new SimpleDateFormat("yyyy", aLocale);
    SimpleDateFormat eventDateFormat = new SimpleDateFormat("yyyy-MM-dd", aLocale);
    ...
    public CustomCalendarView(Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CheckBox alarmMe = addView.findViewById(R.id.alertme);
                ...
                SetTime.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(addView.getContext(), R.style.Widget_AppCompat_ActionBar_Solid
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                SimpleDateFormat hformate = new SimpleDateFormat("K:mm a", aLocale);
    ...
    private void SaveEvent(String event, String time, String date, String month, String year,String notify){
        ...
        dbOpenHelper.close();
        Toast.makeText(context, "Eveniment salvat", Toast.LENGTH_SHORT).show();
